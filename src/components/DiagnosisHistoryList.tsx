          ...
          <div key={diagnosis.id} className="border-t pt-4">
            <div className="flex justify-between items-start mb-3">
              <div>
                <div className="flex items-center gap-2">
                  ...
                  {diagnosis.template?.icdLink && (
                    <a
                      href={diagnosis.template.icdLink}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-600 hover:text-blue-800 inline-flex items-center gap-1"
                    >
                      <span className="text-sm">МКБ {diagnosis.template.icdCode}</span>
            ...
            <div className="mt-2 grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                {diagnosis.template?.treatments.map(treatment => {
                  if (treatment.name === diagnosis.selectedTreatment) {
                    return (
                      <div key={treatment.name} className="text-sm text-gray-600">
